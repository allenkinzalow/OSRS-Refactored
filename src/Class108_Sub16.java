...
public class Class108_Sub16 extends Node {

   public byte[] aByteArray1754;
   public static final int anInt1755 = 145;
   public CacheIndex aClass74_Sub1_1756;
   public IndexTable aClass59_1757;
   ...
   public static RSInterface method1926(int var0, int var1) {
      int var2 = var0 >> 16;
      int var3 = var0 & '\uffff';
      if(null == RSInterface.interface_cache[var2] || null == RSInterface.interface_cache[var2][var3]) {
         boolean var4 = AbstractIndex.method1073(var2, 780045770);
         if(!var4) {
            return null;
         }
      }

      return RSInterface.interface_cache[var2][var3];
   }
      ...
      for(int var2 = 0; var2 < Client.anInt2749 * -1829405175; ++var2) {
         ...
         if(null != var4 && var4.method2731(50136375) && var4.definition.hasRenderPriority == var0 && var4.definition.method2284((byte)98)) {
            ...
            if(var5 >= 0 && var5 < 104 && var6 >= 0 && var6 < 104) {
               ...
               Class56.gameScene.method412(Class108_Sub20_Sub2.plane * -570926309, var4.anInt2394 * 171470795, var4.anInt2339 * 826764905, ClientScript.getFloorDrawHeight(var4.anInt2394 * 171470795 + (var4.anInt2349 * -316782016 - 64), var4.anInt2339 * 826764905 + (var4.anInt2349 * -316782016 - 64), Class108_Sub20_Sub2.plane * -570926309, 1608876331), var4.anInt2349 * -316782016 - 64 + 60, var4, var4.anInt2345 * -376471767, var3, var4.aBool2348);
            }
         }
      }
